...
// HanoSnapchatLens SDK utility: result_basic

class HanoSnapchatLensResultBasic
{
    public static function call(HanoSnapchatLensContext $ctx): ?HanoSnapchatLensResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof HanoSnapchatLensError) ? $result->err->msg : (string)$result->err;
