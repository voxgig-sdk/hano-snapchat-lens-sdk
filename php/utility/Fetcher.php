...
// HanoSnapchatLens SDK utility: fetcher

class HanoSnapchatLensFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HanoSnapchatLensSDK/1.0)';
    ...
    public static function call(HanoSnapchatLensContext $ctx, string $fullurl, array $fetchdef): array
    {
