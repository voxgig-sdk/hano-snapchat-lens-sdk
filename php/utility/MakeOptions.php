...
// HanoSnapchatLens SDK utility: make_options

class HanoSnapchatLensMakeOptions
{
    ...
    public static function call(HanoSnapchatLensContext $ctx): array
    {
        ...
        //
        // `HanoSnapchatLensSchema::optspec()` is built from the model:
        ...
        $optspec = HanoSnapchatLensSchema::optspec();
