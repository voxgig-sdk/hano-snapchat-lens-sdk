# HanoSnapchatLens PHP SDK



The PHP SDK for the HanoSnapchatLens API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $lens));
```
...
```
php/
├── hanosnapchatlens_sdk.php          -- Main SDK class
...
The main class (`hanosnapchatlens_sdk.php`) exports the SDK class
