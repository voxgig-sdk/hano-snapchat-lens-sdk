...
// HanoSnapchatLens SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HanoSnapchatLensSDK::test)
...
{
    private const SDK_CLASS = 'HanoSnapchatLensSDK';
    ...
    private const SDK_BASE = 'hanosnapchatlens_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hanosnapchatlens_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
