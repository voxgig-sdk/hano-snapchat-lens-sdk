# HanoSnapchatLens PHP SDK Reference

Complete API reference for the HanoSnapchatLens PHP SDK.
...
#### `HanoSnapchatLensSDK::test($testopts = null, $sdkopts = null)`
