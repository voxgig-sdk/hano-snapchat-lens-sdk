...
class HanoSnapchatLensSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = HanoSnapchatLensHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = HanoSnapchatLensHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!HanoSnapchatLensFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, HanoSnapchatLensFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return HanoSnapchatLensUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = HanoSnapchatLensHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = HanoSnapchatLensHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = HanoSnapchatLensHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new HanoSnapchatLensError($op . "_allow",
                "HanoSnapchatLensSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = HanoSnapchatLensHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new HanoSnapchatLensError("graphql_error",
                "HanoSnapchatLensSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Lens($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_lens === null) {
                $this->_lens = new LensEntity($this, null);
            }
            return $this->_lens;
        }
        return new LensEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new HanoSnapchatLensSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
