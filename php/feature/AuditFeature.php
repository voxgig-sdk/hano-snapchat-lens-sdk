...
// HanoSnapchatLens SDK audit feature
...
class HanoSnapchatLensAuditFeature extends HanoSnapchatLensBaseFeature
{
    ...
    private function _emit(HanoSnapchatLensContext $ctx, string $outcome): void
    {
