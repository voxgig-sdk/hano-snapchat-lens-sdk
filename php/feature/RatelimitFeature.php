...
// HanoSnapchatLens SDK ratelimit feature
...
class HanoSnapchatLensRatelimitFeature extends HanoSnapchatLensBaseFeature
{
    ...
    private function _acquire(HanoSnapchatLensContext $ctx): void
    {
    ...
    private function _track(HanoSnapchatLensContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
