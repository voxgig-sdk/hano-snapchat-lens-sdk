...
// HanoSnapchatLens SDK rbac feature
...
class HanoSnapchatLensRbacFeature extends HanoSnapchatLensBaseFeature
{
    ...
    private function _required(HanoSnapchatLensContext $ctx): ?string
    {
    ...
    private function _reject(HanoSnapchatLensContext $ctx, string $required): void
    {
    ...
    private function _track(HanoSnapchatLensContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
