...
// HanoSnapchatLens SDK clienttrack feature
...
class HanoSnapchatLensClienttrackFeature extends HanoSnapchatLensBaseFeature
{
    ...
    public function PostConstruct(HanoSnapchatLensContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HanoSnapchatLens-SDK';
