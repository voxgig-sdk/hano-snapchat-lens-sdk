...
|---|---|---|
| `ts/` | @voxgig-sdk/hano-snapchat-lens-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hano-snapchat-lens-sdk \
      --repository voxgig-sdk/hano-snapchat-lens-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hano-snapchat-lens-sdk` shows it, and
`npm trust revoke @voxgig-sdk/hano-snapchat-lens-sdk --id=<id>` removes it.
