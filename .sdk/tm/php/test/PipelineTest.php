...
// HanoSnapchatLens SDK pipeline test
//
...
{
    private static function utility(): HanoSnapchatLensUtility
    {
        return new HanoSnapchatLensUtility();
    }
    ...
    private static function ctx(array $over = []): HanoSnapchatLensContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HanoSnapchatLensContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HanoSnapchatLensOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HanoSnapchatLensError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HanoSnapchatLensOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HanoSnapchatLensMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HanoSnapchatLensOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HanoSnapchatLensMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HanoSnapchatLensOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HanoSnapchatLensMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HanoSnapchatLensSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HanoSnapchatLensMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HanoSnapchatLensResponse([]),
            'result' => new HanoSnapchatLensResult([]),
        ]);
        [, $err] = HanoSnapchatLensMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HanoSnapchatLensSpec([]),
            'response' => null,
            'result' => new HanoSnapchatLensResult([]),
        ]);
        [, $err] = HanoSnapchatLensMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HanoSnapchatLensSpec(['step' => 's']),
            'response' => new HanoSnapchatLensResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HanoSnapchatLensResult([]),
        ]);
        [, $err] = HanoSnapchatLensMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HanoSnapchatLensSpec(['step' => 's']),
            'response' => new HanoSnapchatLensResponse(self::resp(200, ['v' => 1])),
            'result' => new HanoSnapchatLensResult([]),
        ]);
        [, $err] = HanoSnapchatLensMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HanoSnapchatLensSpec(['step' => 's']),
            'response' => new HanoSnapchatLensResponse(self::resp(200, ['v' => 2])),
            'result' => new HanoSnapchatLensResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HanoSnapchatLensMakeResponse::call($ctx);
    ...
    {
        $preset = new HanoSnapchatLensResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HanoSnapchatLensSpec([]),
            'response' => new HanoSnapchatLensResponse([]),
            'result' => new HanoSnapchatLensResult([]),
        ...
        [$got, $err] = HanoSnapchatLensMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HanoSnapchatLensResult([])]);
        [, $err] = HanoSnapchatLensMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HanoSnapchatLensSpec([]), 'result' => null]);
        [, $err] = HanoSnapchatLensMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HanoSnapchatLensSpec(['step' => 's']),
            'result' => new HanoSnapchatLensResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HanoSnapchatLensOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HanoSnapchatLensMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HanoSnapchatLensSpec(['step' => 's']),
            'result' => new HanoSnapchatLensResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HanoSnapchatLensOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HanoSnapchatLensMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HanoSnapchatLensResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HanoSnapchatLensSpec([]),
            'result' => new HanoSnapchatLensResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HanoSnapchatLensMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HanoSnapchatLensMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HanoSnapchatLensError('boom', 'boom');
        $utility->fetcher = function (HanoSnapchatLensContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HanoSnapchatLensSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HanoSnapchatLensMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HanoSnapchatLensContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HanoSnapchatLensMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HanoSnapchatLensResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HanoSnapchatLensMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HanoSnapchatLensContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HanoSnapchatLensSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HanoSnapchatLensMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HanoSnapchatLensResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HanoSnapchatLensSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HanoSnapchatLensMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HanoSnapchatLensMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HanoSnapchatLensMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HanoSnapchatLensResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HanoSnapchatLensDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HanoSnapchatLensResult(['ok' => false])]);
        $this->expectException(HanoSnapchatLensError::class);
        HanoSnapchatLensDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HanoSnapchatLensResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HanoSnapchatLensMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HanoSnapchatLensMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HanoSnapchatLensBaseFeature();
        $b = new HanoSnapchatLensBaseFeature();
        HanoSnapchatLensFeatureAdd::call($ctx, $a);
        HanoSnapchatLensFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HanoSnapchatLensBaseFeature
    {
        $f = new HanoSnapchatLensBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HanoSnapchatLensFeatureAdd::call($ctx, self::named_feature('a'));
        HanoSnapchatLensFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HanoSnapchatLensFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HanoSnapchatLensFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HanoSnapchatLensFeatureAdd::call($ctx, $replace);
        ...
        HanoSnapchatLensFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HanoSnapchatLensContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HanoSnapchatLensSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HanoSnapchatLensPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HanoSnapchatLensPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HanoSnapchatLensResponse(['headers' => null]),
            'result' => new HanoSnapchatLensResult([]),
        ]);
        HanoSnapchatLensResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HanoSnapchatLensResultBody::call($ctx);
