...
// HanoSnapchatLens SDK utility type

class HanoSnapchatLensUtility
{
    ...
    public static function copy(HanoSnapchatLensUtility $src): HanoSnapchatLensUtility
    {
        $u = new HanoSnapchatLensUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
