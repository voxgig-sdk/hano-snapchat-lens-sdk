...
// HanoSnapchatLens SDK proxy feature
...
class HanoSnapchatLensProxyFeature extends HanoSnapchatLensBaseFeature
{
    ...
    public function init(HanoSnapchatLensContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HanoSnapchatLensContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
