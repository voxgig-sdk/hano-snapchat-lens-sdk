...
// HanoSnapchatLens SDK timeout feature
...
class HanoSnapchatLensTimeoutFeature extends HanoSnapchatLensBaseFeature
{
    ...
    private function _with_timeout(HanoSnapchatLensContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HanoSnapchatLensContext $_ctx, float $ms): void
    {
        $client = $this->client;
