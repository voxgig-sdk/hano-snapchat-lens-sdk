...
// HanoSnapchatLens SDK netsim feature
...
class HanoSnapchatLensNetsimFeature extends HanoSnapchatLensBaseFeature
{
    ...
    private function _simulate(HanoSnapchatLensContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HanoSnapchatLensContext $ctx, array $applied): void
    {
        $client = $this->client;
