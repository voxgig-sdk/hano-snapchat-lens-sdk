...
// HanoSnapchatLens SDK cache feature
...
class HanoSnapchatLensCacheFeature extends HanoSnapchatLensBaseFeature
{
    ...
    private function _through(HanoSnapchatLensContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
