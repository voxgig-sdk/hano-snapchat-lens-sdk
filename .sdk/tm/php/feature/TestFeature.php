...
// HanoSnapchatLens SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class HanoSnapchatLensTestFeature extends HanoSnapchatLensBaseFeature
{
    ...
    public function init(HanoSnapchatLensContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (HanoSnapchatLensContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = HanoSnapchatLensParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (HanoSnapchatLensContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(HanoSnapchatLensContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = HanoSnapchatLensParam::call($ctx, $k);
