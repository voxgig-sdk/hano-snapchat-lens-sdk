...
// HanoSnapchatLens SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class HanoSnapchatLensTransformResponse
{
    public static function call(HanoSnapchatLensContext $ctx): mixed
    {
        ...
        $transform = HanoSnapchatLensHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
