...
// HanoSnapchatLens SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HanoSnapchatLensMakeRequest
{
    public static function call(HanoSnapchatLensContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HanoSnapchatLensResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HanoSnapchatLensResponse($fetched);
        } else {
