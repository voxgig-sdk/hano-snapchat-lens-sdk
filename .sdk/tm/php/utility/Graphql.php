...
// HanoSnapchatLens SDK utility: graphql
//
...
class HanoSnapchatLensGraphql
{
    ...
    // equivalent.
    public static function body(HanoSnapchatLensContext $ctx): mixed
    {
    ...
    public static function errors(HanoSnapchatLensContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
