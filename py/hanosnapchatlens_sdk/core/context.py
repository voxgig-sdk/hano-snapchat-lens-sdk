...
from hanosnapchatlens_sdk.core.control import HanoSnapchatLensControl
...
from hanosnapchatlens_sdk.core.helpers import get_ctx_prop, to_map
...
class HanoSnapchatLensContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HanoSnapchatLensControl()
        ...
        if isinstance(sp, HanoSnapchatLensSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HanoSnapchatLensResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HanoSnapchatLensResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HanoSnapchatLensOperation({})
    ...
    def make_error(self, code, msg):
        return HanoSnapchatLensError(code, msg, self)
