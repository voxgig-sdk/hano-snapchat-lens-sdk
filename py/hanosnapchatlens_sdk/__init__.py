...
from hanosnapchatlens_sdk.utility import register

# Load features
from hanosnapchatlens_sdk.feature.base_feature import HanoSnapchatLensBaseFeature
from hanosnapchatlens_sdk.features import _has_feature, _make_feature
...
class HanoSnapchatLensSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = HanoSnapchatLensUtility()
    ...
    def get_utility(self):
        return HanoSnapchatLensUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HanoSnapchatLensSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Lens(self, data=None) -> "LensEntity":
        ...
        from hanosnapchatlens_sdk.entity.lens_entity import LensEntity
