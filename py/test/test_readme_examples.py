# HanoSnapchatLens SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HanoSnapchatLensSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HanoSnapchatLensSDK(...) and HanoSnapchatLensSDK.test(...) become
#      HanoSnapchatLensSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hanosnapchatlens_sdk"
_SDK_CLASS = "HanoSnapchatLensSDK"
