...
AQL-driven CLI and REPL for the HanoSnapchatLens SDK. Positional arguments are
...
```sh
go build -o hano-snapchat-lens-cli ./...
```
...
./hano-snapchat-lens-cli load 1 lens
./hano-snapchat-lens-cli load '{id:1}' lens
