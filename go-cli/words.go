...
func registerSDKWords(r *eng.Registry, client *sdk.HanoSnapchatLensSDK) {
...
func runOp(client *sdk.HanoSnapchatLensSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
