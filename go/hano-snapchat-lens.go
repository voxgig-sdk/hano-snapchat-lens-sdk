...
// instead of `sdk.NewHanoSnapchatLensSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *HanoSnapchatLensSDK  { return NewHanoSnapchatLensSDK(nil) }
func Test() *HanoSnapchatLensSDK { return TestSDK(nil, nil) }
