...
type HanoSnapchatLensSDK struct {
	Mode     string
...
func (sdk *HanoSnapchatLensSDK) OptionsMap() map[string]any {
...
func (sdk *HanoSnapchatLensSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HanoSnapchatLensSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HanoSnapchatLensSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HanoSnapchatLensSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *HanoSnapchatLensSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *HanoSnapchatLensSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("HanoSnapchatLensSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *HanoSnapchatLensSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HanoSnapchatLensSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("HanoSnapchatLensSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *HanoSnapchatLensSDK {
	...
	sdk := NewHanoSnapchatLensSDK(sdkopts)
	sdk.Mode = "test"
