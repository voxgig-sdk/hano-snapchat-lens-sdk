...
type LensEntity struct {
	name    string
	client  *core.HanoSnapchatLensSDK
...
func NewLensEntity(client *core.HanoSnapchatLensSDK, entopts map[string]any) *LensEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LensEntity) GetName() string { return e.name }
...
func (e *LensEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LensEntity) Deleted() bool {
	return e.deleted
}


func (e *LensEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLensEntity(e.client, opts)
}

func (e *LensEntity) Data(args ...any) any {
...
func (e *LensEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Lens; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LensEntity) DataTyped(data ...Lens) Lens {
	if len(data) > 0 {
		return typedFrom[Lens](e.Data(asMap(data[0])))
	}
	return typedFrom[Lens](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Lens (all fields
// optional at the wire level).
func (e *LensEntity) MatchTyped(match ...Lens) Lens {
	if len(match) > 0 {
		return typedFrom[Lens](e.Match(asMap(match[0])))
	}
	return typedFrom[Lens](e.Match())
}
...
func (e *LensEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LensEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LensEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LensListMatch and returns []Lens. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LensEntity) ListTyped(reqmatch LensListMatch, ctrl map[string]any) ([]Lens, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Lens](res), nil
}



func (e *LensEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LensEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LensEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LensEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
