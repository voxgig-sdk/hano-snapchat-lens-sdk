...
require_relative 'HanoSnapchatLens_types'
...
class HanoSnapchatLensSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = HanoSnapchatLensHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = HanoSnapchatLensHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, HanoSnapchatLensFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    HanoSnapchatLensUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = HanoSnapchatLensHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = HanoSnapchatLensHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = HanoSnapchatLensHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    rescue HanoSnapchatLensError => err
    ...
    if fetched.is_a?(Hash)
      status = HanoSnapchatLensHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = HanoSnapchatLensError.new(
        "graphql_error", "HanoSnapchatLensSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = HanoSnapchatLensSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
