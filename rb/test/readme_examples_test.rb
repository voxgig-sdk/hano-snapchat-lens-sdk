...
#      offline in seeded test mode (HanoSnapchatLensSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HanoSnapchatLens_sdk.rb")
  SDK_CLASS = "HanoSnapchatLensSDK"
