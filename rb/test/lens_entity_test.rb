...
class LensEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set HANO_SNAPCHAT_LENS_TEST_LENS_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def lens_basic_setup(extra)
  ...
  entid_env_raw = ENV["HANO_SNAPCHAT_LENS_TEST_LENS_ENTID"]
