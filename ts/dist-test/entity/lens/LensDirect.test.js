...
(0, node_test_1.describe)('LensDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HanoSnapchatLensSDK({
    ...
    (0, node_test_1.test)('direct-list-lens', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-lens', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HANO_SNAPCHAT_LENS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HanoSnapchatLensSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['HANO_SNAPCHAT_LENS_TEST_LENS_ENTID'];
    ...
    const client = new __1.HanoSnapchatLensSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LensDirect.test.js.map