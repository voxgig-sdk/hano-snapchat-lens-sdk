...
function envOverride(m) {
    if ('TRUE' === process.env.HANO_SNAPCHAT_LENS_TEST_LIVE ||
        'TRUE' === process.env.HANO_SNAPCHAT_LENS_TEST_OVERRIDE) {
    ...
    m.HANO_SNAPCHAT_LENS_TEST_EXPLAIN = process.env.HANO_SNAPCHAT_LENS_TEST_EXPLAIN || m.HANO_SNAPCHAT_LENS_TEST_EXPLAIN;
    return m;
}
