...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.HANOSNAPCHATLENS_TEST_LIVE ||
    'TRUE' === process.env.HANOSNAPCHATLENS_TEST_OVERRIDE
  ) {
  ...
  m.HANOSNAPCHATLENS_TEST_EXPLAIN = process.env.HANOSNAPCHATLENS_TEST_EXPLAIN || m.HANOSNAPCHATLENS_TEST_EXPLAIN
