...
describe("LensDirect", function()
  it("should direct-list-lens", function()
    local setup = lens_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-lens", setup.live and "live" or "unit")
