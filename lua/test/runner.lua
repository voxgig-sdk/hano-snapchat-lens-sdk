...
function runner.env_override(m)
  local live = runner.getenv("HANOSNAPCHATLENS_TEST_LIVE")
  local override = runner.getenv("HANOSNAPCHATLENS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HANOSNAPCHATLENS_TEST_EXPLAIN")
