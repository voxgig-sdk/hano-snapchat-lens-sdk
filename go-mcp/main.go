// Command HanoSnapchatLens-mcp is an MCP server exposing the HanoSnapchatLens
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HanoSnapchatLens_list  — list records of an entity
//	HanoSnapchatLens_load  — load a single record of an entity
//
