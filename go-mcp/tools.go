...
type Args struct {
	Entity string         `json:"entity" jsonschema:"lens"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HanoSnapchatLensSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "hano-snapchat-lens_list",
		Description: "List records from HanoSnapchatLens. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "hano-snapchat-lens_load",
		Description: "Load a single record from HanoSnapchatLens. " +
...
func runOp(client *sdk.HanoSnapchatLensSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HanoSnapchatLensSDK, name string) (sdk.HanoSnapchatLensEntity, error) {
	switch strings.ToLower(name) {
	case "lens":
		return client.Lens(nil), nil
